...
mkdir D:\LOGs\ServicesHandlerLogs\
#Select-String -Path C:\inetpub\logs\LogFiles\W3SVC2\u_ex220920_x.log -Pattern "- 200" >D:\Temp\$env:computername.txt
#Read-Host -Prompt "Press Any Ket To Continue"
#aws s3 cp D:\Temp\$env:computername.txt s3://corecard-pod2-patuat-us-east-1-config-files/Copy/Temp/$env:computername.txt
