...
mkdir D:\Temp1\
Copy-Item -Path  D:\WebServer\ScaleService\Log\*.* -Destination D:\Temp1\
#Read-Host -Prompt "Press Any Ket To Continue"
sleep -Seconds 3

aws s3 cp D:\Temp1\ s3://corecard-pod2-patuat-us-east-1-config-files/Copy/Temp/$Hostname --recursive
