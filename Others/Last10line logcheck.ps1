...
 
$report += Get-Content -Path C:\inetpub\logs\LogFiles\W3SVC2\u_ex230508_x.log | select -Last 100 | Select-String -Pattern "- 50*"
#$report += Get-Content -Path C:\inetpub\logs\LogFiles\W3SVC2\u_ex230508_x.log | Select-String -Pattern "- 500", "- 503"
 
