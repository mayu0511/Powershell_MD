...
$EmailReceiver =  @("POD3ConfigTeam@corecard.com","PODConfigTeam@corecard.com")
...
# Determine Environment Message Based on Domain
...
# Example Usage in Email Subject
$EmailSubject = "$environmentMessage"
...
Write-Host "Email Notification Sent with Subject: $EmailSubject" -ForegroundColor Green
