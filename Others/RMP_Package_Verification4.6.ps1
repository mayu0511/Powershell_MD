...
# Version 4.6 | Delete from Package (KMS.zip,CoreOPS.zip/DataBasePackage_CoreOps.zip/PostgreSQL_CoreOps.zip)| Mahendra | Date:: 05 May 2026
#=====================================================================================================================
...
#------------Clear All Variable------
    ...
    $packagedir = 'D:\Packages\COOKIE\POD2\PROD\'
    $packagename = Read-Host "Step 1: Enter the RMP Package Name to zip (e.g., CP7369_POD2-PAT-QA_26.2.1_TO_26.2.6)"
