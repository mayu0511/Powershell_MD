...
if([string]$Outputreport -notmatch "LightSalmon"){$EmailSubject = "[$($Environmentattributon.ToUpper()) $($EnvironmentName.ToUpper()) - $($Environmentpod.ToUpper())] -- [SetupFile Validation Report] -- [Success]"}
else{$EmailSubject = "[$($Environmentattributon.ToUpper()) $($EnvironmentName.ToUpper()) - $($Environmentpod.ToUpper())] -- [SetupFile Validation Report] -- [Failure]"}
