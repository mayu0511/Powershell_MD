...
mkdir D:\Temp1\
Copy-Item -Path  C:\inetpub\logs\LogFiles\W3SVC2\u_ex230227_x.log -Destination D:\Temp1\$env:computername.log
#Read-Host -Prompt "Press Any Ket To Continue"
sleep -Seconds 3

aws s3 cp D:\Temp1\$env:computername.log s3://corecard-pod2-prod-us-west-2-config-files/Copy/Temp/$env:computername.log
