...
SET IPMFileIN=%base%\Dump\MasterCard\IPMSettlement\Incoming\T120
...
SET PlatPIIHubEnv=PATUAT
SET PlatPIIHubTokenEnv=PATUAT
SET PlatAutoRewardRedeem=PATUAT
...
SET StatementDataQueueName=CCPOD2-SQSQueue-PATUAT-us-east-1
...
REM TAG: SET emPassword=rd@PRODr03CC DELETED/COMMENTED ON 10/1/2025 11:42:23 AM Machine Name: VMPACKAGE05(UserName: gMSA-RMP$)
...
SET MailSender_StlRcn=pod2-PATUAT-alerts@infra.marcus.com
...
SET IPMFileSequence=A004,A005,A006,A001,A002
...
REW This will work on your Setup / now value is defuslt please SET as per your Setup 
REM it will work with platform SQS feature - 4.2.42.21

REM AWS Access key from application
SET AWS_ACCESS_KEY_ID=NONE
REM SET AWS_SECRET_ACCESS_KEY=NONE
...
SET SQSS3Bucket=corecard-pod2-patuat-us-east-1-statement-gen/extended-SQS-pod2
...
SET S3Role=NONE
SET S3BucketName=corecard-pod2-patuat-us-east-1-statement-gen/notifications
...
SET TestStatementDataQueueName=CCPOD2-SQSQueue-PATUAT-us-east-1
SET TestSQSS3Bucket=corecard-pod2-patuat-us-east-1-statement-gen/extended-SQS-pod2
SET TestSQSURL=https://sqs.us-east-1.amazonaws.com/508870504450
SET TestSQSS3Url=https://s3.us-east-1.amazonaws.com
SET TestS3BucketName=corecard-pod2-patuat-us-east-1-statement-gen/notifications
...
SET SQSCustomURL=https://vpce-0589936e2570aa08f-j3e63yfk.sqs.us-east-1.vpce.amazonaws.com
