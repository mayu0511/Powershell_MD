class SetUp:
    ...
    InsitutionID = 6981
    MailFrom = "pod2-patuat-alerts@infra.marcus.com"
    MailTo = "Pod2ConfigTeam@corecard.com,gs-credit-cookie-cm-jobs@ny.email.gs.com,platalertsupport@corecard.com"
    ...
    RetailAWS_secret_name = "ses-smtp-patuat-secret"
    ...
    RetailAWSPort = 587
    POTBEnvironment = "PATUAT"
    POTBInstitutionID = 6969
    EnvironmentName = "PLAT PATUAT"
    ...
    IrvingReport_FileEmpty= "D:\DBBSetup\Dump\IrvingReport\Out\6969"
    ...
    POTBAWS_secret_name = "ses-smtp-patuat-secret"
