class SetUp:
    ...
    InsitutionID = 6981
    MailFrom = "pod2-prod-alerts@infra.marcus.com"
    ...
    RetailAWS_secret_name = "ses-smtp-prod-secret"
    ...
    RetailAWSPort = 587
    POTBEnvironment = "PRODUCTION - POD2"
    ...
    POTBAWS_secret_name = "ses-smtp-prod-secret"
