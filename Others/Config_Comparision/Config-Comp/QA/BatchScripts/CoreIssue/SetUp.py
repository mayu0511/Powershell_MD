class SetUp:
    ...
    InsitutionID = 6981
    MailFrom = "pod2-qa-alerts@infra.marcus.com"
    ...
    RetailAWS_secret_name = "ses-smtp-qa-secret"
    ...
    RetailAWSPort = 587
    POTBEnvironment = "PLATQA"
    POTBInstitutionID = 6969
    EnvironmentName = "PLATQA"
    ...
    POTBAWS_secret_name = "ses-smtp-qa-secret"
