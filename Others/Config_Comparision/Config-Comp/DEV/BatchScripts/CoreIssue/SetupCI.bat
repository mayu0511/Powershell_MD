...
REM SET PHFileEnvName = P2MA_PLATDEV
...
set CAuth_PORT=4427
set SCALE_SERVER_HOST=CCWEBe1DEVb1
...
SET PlatPIIHubEnv=DEV
SET PlatPIIHubTokenEnv=DEV
SET PlatAutoRewardRedeem=DEV
SET RelaxIssueStatusCheckForActivation=TEST

SET emKMSdefaultMachines=CCKMSe1DEVb1 CCKMSe1DEVb2

SET emThalesConnectionAddrBase=dev.hsm.infra.marcus.com dev-apps.hsm.infra.marcus.com



Rem Update PlatModelScore value 
SET PlatModelScore=DEV
...
SET MailSender_StlRcn=DEV-alerts@infra.marcus.com
...
SET RptSrvrName_StlRcn=link_CCRPTE1DEV1
...
SET StatementDataQueueName=CCPOD2-SQSQueue-DEV-us-east-1
REM SQS Message store Variables
SET SQSRole=NONE
...
SET S3Role=NONE
SET S3BucketName=corecard-pod2-dev-us-east-1-statement-gen/notifications
