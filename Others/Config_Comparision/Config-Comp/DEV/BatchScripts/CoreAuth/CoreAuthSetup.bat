...
REM SET PHFileVersionName = 24.4.3
...
if /I %MastercardInterfaceProcessor%==0.0.0.0(5545) SET DSLName=CS_MC_SIM
SET TLS12Required=NO
...
SET NetworkManagementInformationCode=061
