...
SET CAuth_PORT=4427
SET SCALE_SERVER_HOST=CCWEBe1PERFb1
...
SET PlatPIIHubEnv=PERFPROD
SET PlatPIIHubTokenEnv=PERFPROD
SET PlatAutoRewardRedeem=PERFPROD
...
SET StatementDataQueueName=CCPOD2-SQSQueue-PERF-us-east-1
...
REM TAG: SET emPassword=rd@PRODr03CC DELETED/COMMENTED ON 8/27/2025 12:28:34 PM Machine Name: VMPACKAGE05(UserName: gMSA-RMP$)
SET InterestAlertByTNP=0


SET emKMSdefaultMachines=CCKMSe1PERFb1 CCKMSe1PERFb2 CCKMSe1PERFb3 CCKMSe1PERFb4 CCKMSe1PERFb5 CCKMSe1PERFb6 CCKMSe1PERFb7
SET emThalesConnectionAddrBase=perf.hsm.infra.marcus.com perf-apps.hsm.infra.marcus.com
...
SET MailSender_StlRcn=pod2-PERFPROD-alerts@infra.marcus.com
SET MailReceiver_StlRcn=None
...
SET SQSRole=NONE
SET SQSURL=https://sqs.us-east-1.amazonaws.com/838438491132
SET SQSS3Bucket=corecard-pod2-perf-us-east-1-statement-gen/extended-SQS-pod2
...
SET APIStore=S3
SET StatementmetaDataPath=E:\CoreBankCard\statementmetadata\

REM to store API response in s3
SET S3URL=https://s3.us-east-1.amazonaws.com
SET S3Role=NONE
SET S3BucketName=corecard-pod2-perf-us-east-1-statement-gen/notifications
...
SET TestSQSURL=https://sqs.us-east-1.amazonaws.com
SET TestSQSS3Url=https://s3.us-east-1.amazonaws.com
SET TestS3BucketName=corecard-pod2-perf-us-east-1-statement-gen/sha256-mismatch
...
SET SQSCustomURL=https://vpce-0cf784a0e5fa2b80d-o6uettqe.sqs.us-east-1.vpce.amazonaws.com
SET KMSENC_S3ExternalID=
SET _emdbPDdisable=1
REM SET KMSENC_SQSExternalID=<KMSENC_SQSExternalID>
SET KMSENC_SQSExternalID=
SET AllowExtendExpirationDate=TEST
REM For Production please SET AllowExtendExpirationDate=PROD other than PROD we only SET AllowExtendExpirationDate=TEST
