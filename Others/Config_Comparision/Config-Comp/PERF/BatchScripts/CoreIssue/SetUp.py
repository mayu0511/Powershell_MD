class SetUp:
    ...
    InsitutionID = 6981
    MailFrom = "pod2-perf-alerts@infra.marcus.com"
    ...
    RetailAWS_secret_name = "ses-smtp-perf-secret"
    ...
    RetailAWSPort = 587
    POTBEnvironment = "PATPERF"
    POTBInstitutionID = 6969
    EnvironmentName = "PLATPERF"
    ...
    POTBAWS_secret_name = "ses-smtp-perf-secret"
