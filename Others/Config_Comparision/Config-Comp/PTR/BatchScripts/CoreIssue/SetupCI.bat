...
set CAuth_PORT=4427
set SCALE_SERVER_HOST=CCWEBe1PATQAb1
...
SET PlatPIIHubEnv=PATQA
SET PlatPIIHubTokenEnv=PATQA
SET PlatAutoRewardRedeem=PATQA
SET RelaxIssueStatusCheckForActivation=TEST

SET emKMSdefaultMachines=CCKMSe1PATQAb1 CCKMSe1PATQAb2 

SET emThalesConnectionAddrBase=patqa.hsm.infra.marcus.com patqa-apps.hsm.infra.marcus.com



Rem Update PlatModelScore value 
SET PlatModelScore=PATQA
...
SET IPMFileIN=%dump%\MasterCard\IPMSettlement\Incoming\T120
...
SET IPMFileArchive=%dump%\MasterCard\IPMSettlement\Incoming\T120\Archive
...
REM TAG: SET emPassword=rd@PRODr03CC DELETED/COMMENTED ON 8/28/2025 12:04:35 PM Machine Name: VMPACKAGE05(UserName: gMSA-RMP$)
...
SET MailSender_StlRcn=pod2-PATQA-alerts@infra.marcus.com
...
SET RptSrvrName_StlRcn=link_CCRPTE1PATQA1
...
SET TestStatementDataQueueName=CCPOD2-SQSQueue-PATQA-us-east-1
SET TestSQSS3Bucket=corecard-pod2-patqa-us-east-1-statement-gen/extended-SQS-pod2
SET TestSQSURL=https://sqs.us-east-1.amazonaws.com/508870504450
SET TestSQSS3Url=https://s3.us-east-1.amazonaws.com
SET TestS3BucketName=corecard-pod2-patqa-us-east-1-statement-gen/notifications
...
SET StatementDataQueueName=CCPOD2-SQSQueue-PATQA-us-east-1
REM SQS Message store Variables
SET SQSRole=NONE
SET SQSURL=https://sqs.us-east-1.amazonaws.com/508870504450
SET SQSS3Bucket=corecard-pod2-patqa-us-east-1-statement-gen/extended-SQS-pod2
...
SET S3Role=NONE
SET S3BucketName=corecard-pod2-patqa-us-east-1-statement-gen/notifications
...
SET SQSCustomURL=https://vpce-0517805b1516275c0-d676jk62.sqs.us-east-1.vpce.amazonaws.com
