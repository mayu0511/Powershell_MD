class SetUp:
    ...
    InsitutionID = 6981
    MailFrom = "pod2-patqa-alerts@infra.marcus.com"
    ...
    RetailAWS_secret_name = "ses-smtp-patqa-secret"
    ...
    RetailAWSPort = 587
    POTBEnvironment = "PATQA"
    POTBInstitutionID = 6969
    EnvironmentName = "PLAT PATQA"
    ...
    POTBAWS_secret_name = "ses-smtp-patqa-secret"
