...
SET CAuth_PORT=4427
SET SCALE_SERVER_HOST=CCWEBe1UATb1
...
SET PlatPIIHubEnv=UAT
SET PlatPIIHubTokenEnv=UAT
SET PlatAutoRewardRedeem=UAT
...
SET StatementDataQueueName=CCPOD2-SQSQueue-UAT-us-east-1
...
REM TAG: SET emPassword=rd@PRODr03CC DELETED/COMMENTED ON 8/7/2025 5:36:18 PM Machine Name: VMPACKAGE05(UserName: gMSA-RMP$)
SET InterestAlertByTNP=0


SET emKMSdefaultMachines=CCKMSe1UATb1 CCKMSe1UATb2
SET emThalesConnectionAddrBase=uat.hsm.infra.marcus.com uat-apps.hsm.infra.marcus.com
...
SET MailSender_StlRcn=pod2-UAT-alerts@infra.marcus.com
SET MailReceiver_StlRcn=asharma@corecard.com,sagrawal@corecard.com,ranveer.thakur@corecard.com,durgesh.wadbude@corecard.com
...
SET S3URL=NONE
SET S3Role=NONE
SET S3BucketName=NONE
SET S3Region=us-east-1
SET S3STSUrl=NONE
SET S3STSRegion=NONE
