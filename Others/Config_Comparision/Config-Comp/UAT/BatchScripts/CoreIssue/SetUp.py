class SetUp:
    ...
    InsitutionID = 6981
    MailFrom = "pod2-uat-alerts@infra.marcus.com"
    ...
    RetailAWS_secret_name = "ses-smtp-uat-secret"
    ...
    POTBAWS_secret_name = "ses-smtp-uat-secret"
