...
mkdir D:\Temp1\
Select-String -Path C:\inetpub\logs\LogFiles\W3SVC2\u_ex230508_x*.log -Pattern "- 503" >>D:\Temp1\$env:computername.txt
#Select-String -Path C:\inetpub\logs\LogFiles\W3SVC2\u_ex2304*.log -Pattern "1f76264e-fb83-4adf-9ba7-cc5ae8bfd3c7" >>D:\Temp1\$env:computername.txt

#Read-Host -Prompt "Press Any Ket To Continue"
#sleep -Seconds 3
aws s3 cp D:\Temp1\$env:computername.txt s3://corecard-pod2-prod-us-west-2-config-files/Copy/Temp/$env:computername.txt
