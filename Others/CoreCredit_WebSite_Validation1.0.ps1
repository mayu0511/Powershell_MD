...
$CoreCarditSSLRequest = Invoke-WebRequest $CoreCreditSSLURL
...
$ReportServerURLtest = Test-NetConnection $ReportServerPathbaseURL -port 443
}
Catch{
$ReportServerURLtest = $_ | Out-String
}

if ($ReportServerURLtest.TcpTestSucceeded -eq "True")
{
