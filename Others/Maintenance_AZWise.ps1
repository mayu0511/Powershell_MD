...
Invoke-Command -ComputerName $ServerList -SessionOption $option -ScriptBlock {
...
[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12
  ...
  #$response = Invoke-WebRequest -Uri "https://$IP/HealthCoreIssue/api/server/maintenance/1" -Method GET -UseDefaultCredentials
$response.Content
}