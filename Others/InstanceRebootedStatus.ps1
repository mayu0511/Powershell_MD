...
$Report = @()
$ServersType = "*ccisse1*","*ccsvce1*","*ccaute1*","*cctnpe1*","*ccawfe1*","*ccsnke1*","*ccsrce1*","*ccbate1*"
...
</style></head><body><h1>Server Reboot Report</h1><table>" -PostContent "</table></body></html>" | Out-String
