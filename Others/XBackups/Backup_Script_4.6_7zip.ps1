...
# Version 4.5 | ORIGINAL STYLE (Empty Folder Fix Added, No Minimization)
############################################################################################################
...
if ($doStep1) {
    ...
    if (!(Test-Path $monitorPath)) {
        ...
        Log "MonitoringScript folder not found at: $monitorPath"
        Log "Skipping MonitoringScript zipping..."
    ...
    Log "Skipped MonitoringScript processing."
}
# ========================
...
if ($continueStep2) {
    ...
    if (!(Test-Path $dbbPath)) {
        ...
        Log "DBBSetup folder not found at: $dbbPath"
        Log "Skipping DBBSetup zipping..."
