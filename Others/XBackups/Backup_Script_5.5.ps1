...
#Version 5.5 Task IMport Only gmsa account | Updated by Mahendra | 14-APril-26
#Version 5.5 Task IMprovement Deploy code steps | Updated by Mahendra | 14-APril-26
#Version 5.5 Added Server Types Coreops | Updated by Mahendra | 23-APril-26
...
# ========================
# Task- 20: UPLOAD TO S3 (INDEPENDENT)
# ========================
...
if ($unzipChoice.Trim().ToLower() -eq "y") {
    ...
    # ========================
    # Function: Expand Zip Recursively
    # ========================
    ...
    # ========================
    # Function: Remove Duplicate Folders
    # ========================
    ...
    foreach ($folder in $folders) {
        ...
        if (Test-Path $duplicatePath) {
            ...
            if (Test-Path $duplicatePath) {
                $remaining = Get-ChildItem $duplicatePath -Force

                if ($remaining.Count -eq 0) {
                    Remove-Item $duplicatePath -Recurse -Force
                    Log "Removed empty duplicate folder"
                }
                else {
                    Log "Duplicate not empty, skipping delete"
                }
            }
        }
    }
...
if ($deployChoice -eq "y") {
    ...
    foreach ($f in $folders) {
        ...
        if (Test-Path $src) {
            ...
            # ? Step 1: Copy folder structure (including empty folders)
...
# ========================
# TASK- 23.2 VERIFY FILE COUNT After Deployment
# ========================
...
# ========================
# Task- 24.3 IMPORT TASKS
# ========================

Log "`n=== IMPORTING TASKS ==="

$taskFiles = Get-ChildItem -Path $importDir -Filter *.xml -ErrorAction SilentlyContinue
...
Log "===== FULL SCRIPT COMPLETED SUCCESSFULLY ====="