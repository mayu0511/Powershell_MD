...
function Zip-FolderWith7Zip {
    ...
    try {
        ...
        # ? CRITICAL FIX (NO DUPLICATE FOLDER EVER)
...
function Download-And-Deploy-Package {
    ...
    foreach ($folder in $folders) {
        ...
        if (Test-Path $duplicatePath) {
            ...
            # Delete duplicate ONLY if empty
