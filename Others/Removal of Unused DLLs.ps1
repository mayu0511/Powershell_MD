...
# Paths & Setup
# =========================
$BaseLogPath = "C:\Temp\DLLdelete\Logs"
$ReportPath  = "C:\Temp\DLLdelete\Report"
$LogFile     = Join-Path $BaseLogPath "DeleteSteps.log"
$HtmlReport  = Join-Path $ReportPath "DeleteReport.html"
...
Write-Log "HTML report created with color coding"
