...
# Version 4.2 | Updated the POD1 Details of Non-Prod and Prod | | Date:: 28-July-2026
######################################################################################################################
...
switch ($EnvironmentDomain) {
    "CC-POD1-PATUAT" { $ServicesURL="https://services.patuat.api.cc-pod1.infra.marcus.com/" }
    "CC-POD1-PATQA"  { $ServicesURL="https://services.patqa.api.cc-pod1.infra.marcus.com/" }
    "CC-POD1-PERF"   { $ServicesURL="https://services.perf.api.cc-pod1.infra.marcus.com/" }
	...
	"CC-POD1-PROD"   { $ServicesURL="https://services.api.cc-pod1.infra.marcus.com/" }
