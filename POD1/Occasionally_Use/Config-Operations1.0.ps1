...
# Version 1.0 | Updataion of NetworkManagementAPI in WCF and gmsa user Date: 22-July-2026 | Enhanced By Netra Chettri 
#======================================================================================================================
...
$PODsList = @("COOKIE-POD1", "COOKIE-POD2", "COOKIE-POD4")}
