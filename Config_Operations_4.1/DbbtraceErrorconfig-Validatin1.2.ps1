######################################################################################################################
# Dbbtrace and ErrorConfig Check  | DEVELOPED BY:: Mahendra Dwivedi
# Version 1.1 | Dbbtrace and ErrorConfig | Date:: 23-July-2025
#=====================================================================================================================
...
Write-Host "Checking and restarting WinRM service if stopped..."
...
Write-Host "Performing hash comparison on the following servers:`n$($ServerList -join ', ')`n"
