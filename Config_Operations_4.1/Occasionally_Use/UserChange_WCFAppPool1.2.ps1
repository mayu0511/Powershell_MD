...
# Version 1.0 | Updated with multiple user selection | Date:: 05-Nov-2025
# Version 1.1 | Remove * for all az selection | Date:: 10-April-2026
# Version 1.2 | Add POD1 Syntex  | Date:: 29-July-2026
######################################################################################################################
...
Write-Host "1. cc-pod1-prod\gmsa-app-svc$"
Write-Host "2. cc-pod1-prod\gmsa-app-upg$"
Write-Host "3. cc-pod2-prod\gmsa-app-svc$"
Write-Host "4. cc-pod2-prod\gmsa-app-upg$"
Write-Host "5. cc-pod4-prod\gmsa-app-svc$"
Write-Host "6. cc-pod4-prod\gmsa-app-upg$"

$userChoice = Read-Host "Enter your choice (1-4)"

switch ($userChoice) {
    '1' { $userName = "cc-pod1-prod\gmsa-app-svc$" }
    '2' { $userName = "cc-pod1-prod\gmsa-app-upg$" }
	'3' { $userName = "cc-pod2-prod\gmsa-app-svc$" }
    '4' { $userName = "cc-pod2-prod\gmsa-app-upg$" }
    '5' { $userName = "cc-pod4-prod\gmsa-app-svc$" }
    '6' { $userName = "cc-pod4-prod\gmsa-app-upg$" }
    Default {
