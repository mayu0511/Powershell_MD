...
$SetupFileList = "D:\DBBSetup\BatchScripts\CoreIssue\SetupCI.bat","D:\DBBSetup\BatchScripts\CoreIssue\SetUp.py","D:\DBBSetup\BatchScripts\CoreIssue\SetupCIPy.ini","D:\DBBSetup\BatchScripts\CoreAuth\CoreAuthSetup.bat","D:\DBBSetup\DSLs\CI\About.DSL","D:\DBBSetup\DSLs\CoreAuth\About.DSL","D:\CC_Runtime\appsys30.DSL"
$SetupCIEnvVarialbeList = 'SET DB_Server_NAME=', 'SET ReportsCoreAuthDBName=', 'SET EXECUTABLEPATH=', 'SET StatementDataQueueName=', 'SET emKMSdefaultMachines=', 'SET emThalesConnectionAddrBase=', 'SET SCALE_SERVER_HOST=', 'SET Enviroment=', 'SET ExperianSetup=', 'SET PlatPIIHubEnv=', 'SET PlatPIIHubTokenEnv=', 'SET PlatAutoRewardRedeem=', 'SET RelaxIssueStatusCheckForActivation=', 'SET DummyMmsApiResult=', 'SET UsePIIFromBearerForEmbossing=', 'SET InterestAlertByTNP=', 'SET PodActiveTQR4=', 'SET PlatModelScore=', 'SET DummyModelScore=', 'SET MultiPODEnabled_IPM=', 'SET TokenRefreshCall=', 'SET UseBhubFromBearerForEmbossing=', 'SET RptSrvrName_StlRcn=', 'SET MailSender_StlRcn=', 'SET MessageQueueService=', 'SET SQSRole=', 'SET SQSURL=', 'SET SQSS3Bucket=', 'SET SQSRegion=', 'SET SQSSTSlink=', 'SET SQSSTSRegion=', 'SET SQSS3Url=', 'SET SQSS3Region=', 'SET APIStore=', 'SET S3URL=', 'SET S3Role=' , 'SET S3BucketName=', 'SET S3Region=', 'SET S3STSUrl=', 'SET S3STSRegion=', 'SET S3URLAlert=', 'SET S3RegionAlert=', 'SET AWSRoleAlert=', 'SET SQSURLAlert=', 'SET SQSRegionAlert='
...
param ($SetupFileList, $SetupCIEnvVarialbeList, $SetUppyEnvVarialbeList, $SetupCIPyEnvVarialbeList, $CoreAuthSetupEnvVarialbeList, $AboutDSLVarialbeList, $PlatformVersionVarialbeList)
...
} -ArgumentList $SetupFileList, $SetupCIEnvVarialbeList, $SetUppyEnvVarialbeList, $SetupCIPyEnvVarialbeList, $CoreAuthSetupEnvVarialbeList, $AboutDSLVarialbeList, $PlatformVersionVarialbeList
